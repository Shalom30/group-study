...
import { FileText, Upload, BookOpen, Brain, Loader2 } from 'lucide-react'
...
function FlashCard({ card, index }) {
  ...
  return (
    <div
      className="cursor-pointer border border-border rounded-xl p-5 hover:shadow-md transition-all"
